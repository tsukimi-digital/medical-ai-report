# Multi-Agent Team — Claude Setup

Ten plik definiuje sposób pracy Claude jako orkiestratora zespołu agentów.
Skopiuj go jako `CLAUDE.md` do katalogu projektu.

---

## Rola Claude (główne okno)

Claude w głównym oknie jest **orkiestratorem** — nie pisze kodu samodzielnie.
